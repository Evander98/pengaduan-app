...
const TambahLegislasi = ({navigation}) => {
  ...
  const onSubmit = () => {
    if(judul && isi && pengusul) {
      axios.post(urlAPI + '/legislation/add', {judul, isi, pengusul})
      .then((res) => {
...
export default TambahLegislasi
